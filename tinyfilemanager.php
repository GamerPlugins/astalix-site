...
//Application Title
define('APP_TITLE', 'КСТ File Manager');
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/group';
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> <?php echo lng('Загрузить по ссылке') ?></a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                <div class="upload-url-wrapper card-tabs-container hidden" id="urlUploader">
                    <form id="js-form-url-upload" class="row row-cols-lg-auto g-3 align-items-center" onsubmit="return upload_from_url(this);" method="POST" action="">
                        ...
                        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                        <button type="submit" class="btn btn ms-3"><?php echo lng('Загрузить') ?></button>
...
if (isset($_POST['copy']) && !FM_READONLY) {
    ...
    <div class="path">
        <div class="card <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <h6><?php echo lng('Копирование') ?></h6>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <p class="break-word"><strong><?php echo lng('Из папки') ?></strong>: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?><br>
                        <label for="inp_copy_to"><strong><?php echo lng('В папку') ?></strong>:</label>
                        <?php echo FM_ROOT_PATH ?>/<input type="text" name="copy_to" id="inp_copy_to" value="<?php echo fm_enc(FM_PATH) ?>">
                    </p>
                    <p class="custom-checkbox custom-control"><input type="checkbox" name="move" value="1" id="js-move-files" class="custom-control-input"><label for="js-move-files" class="custom-control-label ms-2"> <?php echo lng('Переместить') ?></label></p>
                    <p>
                        <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="btn btn-outline-danger"><i class="fa fa-times-circle"></i> <?php echo lng('Закрыть') ?></a></b>&nbsp;
                        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        <p><b>Копирование</b></p>
        <p class="break-word">
            <strong>Из папки:</strong> <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . $copy)) ?><br>
            <strong>В папку:</strong> <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?>
        </p>
        <p>
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i> Copy</a></b> &nbsp;
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i> Переместить</a></b> &nbsp;
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="#" target="_blank" class="app-v-title"> KCT File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Почта для связи: <a href="mailto:s.samsonov@kstpro.ru">s.samsonov@kstpro.ru</a> </p>
                    </div>
    ...
    <div class="path">
        <div class="row">
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-end pt-1">
                <a title="<?php echo lng('Back') ?>" class="btn btn-sm btn-outline" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;view=<?php echo urlencode($file) ?>"><i class="fa fa-reply-all"></i> <?php echo lng('Back') ?></a>
                <a title="<?php echo lng('BackUp') ?>" class="btn btn-sm btn-outline" href="javascript:void(0);" onclick="backup('<?php echo urlencode(trim(FM_PATH)) ?>','<?php echo urlencode($file) ?>')"><i class="fa fa-database"></i> <?php echo lng('BackUp') ?></a>
                <?php if ($is_text) { ?>
                    <?php if ($isNormalEditor) { ?>
                        <a title="Advanced" class="btn btn-sm btn-outline" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&amp;env=ace"><i class="fa fa-pencil-square-o"></i> <?php echo lng('AdvancedEditor') ?></a>
                    ...
                    <?php } else { ?>
                        <a title="Plain Editor" class="btn btn-sm btn-outline" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>"><i class="fa fa-text-height"></i> <?php echo lng('NormalEditor') ?></a>
        ...
        <div class="card mb-2 <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <p>
                       <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>"> 
                        <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="btn btn-outline"><i class="fa fa-times-circle"></i> <?php echo lng('Cancel') ?></a></b>&nbsp;
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                <li class="list-inline-item"><a href="#/invert-all" class="btn btn-small btn-outline btn-2" onclick="invert_all();return false;"><i class="fa fa-th-list"></i> <?php echo lng('InvertSelection') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm('<?php echo lng('Удалить выбранные файлы/папки?'); ?>')">
                    <a href="javascript:document.getElementById('a-delete').click();" class="btn btn-small btn-outline btn-2"><i class="fa fa-trash"></i> <?php echo lng('Delete') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="tar" id="a-tar" value="tar" onclick="return confirm('<?php echo lng('Создать архив?'); ?>')">
                    <a href="javascript:document.getElementById('a-tar').click();" class="btn btn-small btn-outline btn-2"><i class="fa fa-file-archive-o"></i> <?php echo lng('Tar') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="copy" id="a-copy" value="Copy">
                    <a href="javascript:document.getElementById('a-copy').click();" class="btn btn-small btn-outline btn-2"><i class="fa fa-files-o"></i> <?php echo lng('Copy') ?> </a></li>
            </ul>
        </div>
        <div class="col-3 d-none d-sm-block"><a href="#" target="_blank" class="float-right text-muted">KCT File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="#" target="_blank" class="float-right text-muted">KCT File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
                ...
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    <li class="nav-item mr-2">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px;">
                            <input type="text" class="form-control" placeholder="<?php echo lng('Поиск') ?>" aria-label="<?php echo lng('Поиск') ?>" aria-describedby="search-addon2" id="search-addon">
                    ...
                    <?php if (!FM_READONLY): ?>
                    <li class="nav-item">
                        <a title="<?php echo lng('Загрузка на сайт') ?>" class="nav-link" style="color: " href="?p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i> <?php echo lng('Загрузка на сайт') ?></a>
                    </li>
                    <li class="nav-item">
                        <a title="<?php echo lng('Создать') ?>" class="nav-link" href="#createNewItem" data-bs-toggle="modal" data-bs-target="#createNewItem"><i class="fa fa-plus-square"></i> <?php echo lng('Создать') ?></a>
                    </li>
                    <li class="nav-item">
                    <a title="<?php echo lng('О программе') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;help=2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo lng('О программе') ?></a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
...
<head>
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing: border-box;}
        ...
        .inline-actions > a > i { font-size:1em;margin-left:5px;background:#2F678B;color:#fff;padding:3px 4px;border-radius:3px; }
        ...
        .btn-outline { color: #2F678B; }
        .fa-home { color: #2F678B; }
        .btn-outline:hover { color: #ffffff; background-color: #2F678B; }
        li.file:before,li.folder:before { font:normal normal normal 14px/1 FontAwesome;content:"\f016";margin-right:5px }
        li.folder:before { content:"\f114" }
        i.fa.fa-folder-o { color:#2F678B }
        ...
        i.go-back { font-size:1.2em;color:#2F678B; }
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            .theme-dark .btn-outline { color: #b8e59c; border-color: #b8e59c; }
            .theme-dark .btn-outline:hover, .theme-dark .btn-outline:active { background-color: #2d4121;}
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content <?php echo fm_get_theme(); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="newItemModalLabel"><i class="fa fa-plus-square fa-fw"></i><?php echo lng('Создание файла или папки') ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"></button>
                </div>
                <div class="modal-body">
                    <p><label for="newfile"><?php echo lng('Тип') ?> </label></p>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="newfile" id="customRadioInline1" name="newfile" value="file">
                      <label class="form-check-label" for="customRadioInline1"><?php echo lng('Файл') ?></label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="newfile" id="customRadioInline2" value="folder" checked>
                      <label class="form-check-label" for="customRadioInline2"><?php echo lng('Папка') ?></label>
                    </div>

                    <p class="mt-3"><label for="newfilename"><?php echo lng('Название') ?> </label></p>
                    <input type="text" name="newfilename" id="newfilename" value="" class="form-control" placeholder="<?php echo lng('Название файла/папки') ?>" required>
                </div>
                <div class="modal-footer">
                    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                    <button type="button" class="btn btn-outline" data-bs-dismiss="modal"><i class="fa fa-times-circle"></i> <?php echo lng('Отменить') ?></button>
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i> <?php echo lng('Создать') ?></button>
                </div>
            </form>
        </div>
    </div>
          ...
          <div class="modal-header">
            <h5 class="modal-title col-10" id="searchModalLabel">
                <div class="input-group mb-3">
                  <input type="text" class="form-control" placeholder="<?php echo lng('Поиск') ?> <?php echo lng('файлов') ?>" aria-label="<?php echo lng('Поиск') ?>" aria-describedby="search-addon3" id="advanced-search" autofocus required>
          ...
          <div class="modal-body">
            <form action="" method="post">
                ...
                <ul id="search-wrapper">
                    <p class="m-2"><?php echo lng('Поиск файла в папках...') ?></p>
                </ul>
            </form>
          </div>
        </div>
        ...
        <div class="modal modal-alert confirmDailog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" id="confirmDailog-<%this.id%>">
          <div class="modal-dialog" role="document">
            <form class="modal-content rounded-3 shadow <?php echo fm_get_theme(); ?>" method="post" autocomplete="off" action="<%this.action%>">
              <div class="modal-body p-4 text-center">
                <h5 class="mb-2"><?php echo lng('Точно вы хотите') ?> <%this.title%> ?</h5>
                <p class="mb-1"><%this.content%></p>
              </div>
              <div class="modal-footer flex-nowrap p-0">
                <button type="button" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0 border-end" data-bs-dismiss="modal"><?php echo lng('Cancel') ?></button>
                <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                <button type="submit" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0" data-bs-dismiss="modal"><strong><?php echo lng('Да') ?></strong></button>
              </div>
            </form>
          </div>
        </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'База дипломов и титульников';
    $tr['en']['Login']          = 'Sign in';                $tr['en']['Username']           = 'Username';
    $tr['en']['Password']       = 'Password';               $tr['en']['Logout']             = 'Sign Out';
    $tr['en']['Move']           = 'Move';                   $tr['en']['Copy']               = 'Скопировать';
    $tr['en']['Save']           = 'Save';                   $tr['en']['SelectAll']          = 'Выбрать все';
    $tr['en']['UnSelectAll']    = 'Снять выделение со всех файлов';           $tr['en']['File']               = 'Файлов';
    $tr['en']['Back']           = 'Назад';                   $tr['en']['Size']               = 'Размер файла';
    $tr['en']['Perms']          = 'Perms';                  $tr['en']['Modified']           = 'Дата изменения/Дата создания';
    $tr['en']['Owner']          = 'Owner';                  $tr['en']['Search']             = 'Поиск';
    $tr['en']['NewItem']        = 'New Item';               $tr['en']['Folder']             = 'Папок';
    $tr['en']['Delete']         = 'Удалить';                 $tr['en']['Rename']             = 'Переименовать';
    $tr['en']['CopyTo']         = 'Copy to';                $tr['en']['DirectLink']         = 'Direct link';
    $tr['en']['UploadingFiles'] = 'Загрузите файл';           $tr['en']['ChangePermissions']  = 'Change Permissions';
    $tr['en']['Copying']        = 'Copying';                $tr['en']['CreateNewItem']      = 'Create New Item';
    $tr['en']['Name']           = 'Имя файла/папки';                   $tr['en']['AdvancedEditor']     = 'Advanced Editor';
    $tr['en']['Actions']        = 'Действия';                $tr['en']['Folder is empty']    = 'Нет файлов';
    $tr['en']['Upload']         = 'Upload';                 $tr['en']['Cancel']             = 'Закрыть';
    $tr['en']['InvertSelection']= 'Выбрать все/Снять все';       $tr['en']['DestinationFolder']  = 'Выберите файлы';
    $tr['en']['ItemType']       = 'Item Type';              $tr['en']['ItemName']           = 'Item Name';
    $tr['en']['CreateNow']      = 'Create Now';             $tr['en']['Download']           = 'Скачать';
    $tr['en']['Open']           = 'Открыть';                   $tr['en']['UnZip']              = 'UnZip';
    $tr['en']['UnZipToFolder']  = 'UnZip to folder';        $tr['en']['Edit']               = 'Редактировать';
    $tr['en']['NormalEditor']   = 'Normal Editor';          $tr['en']['BackUp']             = 'Back Up';
    $tr['en']['SourceFolder']   = 'Из папки';          $tr['en']['Files']              = 'Файлы';
    $tr['en']['Move']           = 'Move';                   $tr['en']['Change']             = 'Выбрать';
    $tr['en']['Settings']       = 'Settings';               $tr['en']['Language']           = 'Language';        
    $tr['en']['ErrorReporting'] = 'Error Reporting';        $tr['en']['ShowHiddenFiles']    = 'Show Hidden Files';
    $tr['en']['Help']           = 'О программе';                   $tr['en']['Created']            = 'Создан';
    $tr['en']['Help Documents'] = 'Help Documents';         $tr['en']['Report Issue']       = 'Report Issue';
    $tr['en']['Generate']       = 'Generate';               $tr['en']['FullSize']           = 'Полный размер файлов';              
